...
export interface ISchoolUpdateState {
  isNew: boolean;
  directorId: string;
}

export class SchoolUpdate extends React.Component<ISchoolUpdateProps, ISchoolUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
      directorId: '0',
  ...
  handleClose = () => {
    this.props.history.push('/entity/school');
  };

  render() {
    const { schoolEntity, users, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="cupOfGloryApp.school.home.createOrEditLabel">
              <Translate contentKey="cupOfGloryApp.school.home.createOrEditLabel">Create or edit a School</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : schoolEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="id">
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="cupOfGloryApp.school.name">Name</Translate>
                  </Label>
                  <AvField
                    id="school-name"
                    type="text"
